...
public class CopyCollectionBuilderTest extends ErrorTest {
    private final CopyCollectionBuilder<String, List<String>> builder = new CopyCollectionBuilder<String, List<String>>(new NewableArrayList<String>());
    ...
    public void testCallingWithReturnNewBuilderInstance() throws Exception {
        final CopyCollectionBuilder<String, List<String>> builderCopy = builder.with(list1);
    ...
    private void whenBuilderIsConstructedWith(final Newable<List<String>> listNewable) {
        when(new When() {
            ...
            public void isExecuted() {
                new CopyCollectionBuilder<String, List<String>>(listNewable);
            }
        });
    }
}